...
| `specs/*.spec.js` | One file per area. `01`–`03` cover the pure data/state functions; `04`–`11` are behavioural UI tests that click buttons and read the rendered result + the Campaign Log entry it produced. |
