...
function renderActive(){
  ...
  const renderers = { gm:renderGM, adventure:renderAdventure, location:renderLocation, creature:renderCreature, character:renderCharacter, mystery:renderMystery };
  host.innerHTML = renderers[currentTab]();
  wireActive();
}
function wireActive(){
  const wirers = { gm:wireGM, adventure:wireAdventure, location:wireLocation, creature:wireCreature, character:wireCharacter, mystery:wireMystery };
  wirers[currentTab]();
}
